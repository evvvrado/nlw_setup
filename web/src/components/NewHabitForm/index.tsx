			...
			<div className="flex flex-col gap-2 mt-3">
				{avaibleWeekDays.map((weekDay, index) => {
					return (
						...
						>
							<div className="h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-green-500 group-data-[state=checked]:border-green-300 transition-colors">
								<Checkbox.Indicator>
